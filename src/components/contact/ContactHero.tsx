      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col h-[calc(100vh-5rem)] justify-center">
          <div className="flex flex-col">
            ...
            <motion.h1 
              className="text-[clamp(2rem,7vw,5rem)] font-bold mb-6 font-heading tracking-tight leading-[0.85]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-lg text-white/60 leading-relaxed">
                Kontaktirajte me za besplatne konzultacije i saznajte kako zajedno možemo ostvariti vaše fitness ciljeve.
                <span className="block mt-3 text-white/80 font-medium">
                  Profesionalno vodstvo i podrška na svakom koraku.
                </span>
              </p>
            </motion.div>
